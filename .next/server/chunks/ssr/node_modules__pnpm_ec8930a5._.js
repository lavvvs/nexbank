...
2) With environment variables e.g.
   ...
   NEXT_PUBLIC_CLERK_IS_SATELLITE='true'`,ah=()=>ai("getAuth"),ai=(a="auth",b)=>`Clerk: ${a}() was called but Clerk can't detect usage of clerkMiddleware(). Please ensure the following:
- ${b?[...b,""].join("\n- "):" "}clerkMiddleware() is used in your Next.js Middleware.
- Your Middleware matcher is configured to match this route or page.
- If you are using the src directory, make sure the Middleware file is inside of it.

For more details, see https://clerk.com/err/auth-middleware
`,aj="Clerk: Unable to verify request, this usually means the Clerk middleware did not run. Ensure Clerk's middleware is properly integrated and matches the current route. For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware. (code=auth_signature_invalid)",ak="Clerk: Unable to decrypt request data, this usually means the encryption key is invalid. Ensure the encryption key is properly set. For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)",al=`Clerk: Unable to decrypt request data.

Refresh the page if your .env file was just updated. If the issue persists, ensure the encryption key is valid and properly set.

For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)`;a.s(["authAuthHeaderMissing",()=>ai,"authSignatureInvalid",()=>aj,"encryptionKeyInvalid",()=>ak,"encryptionKeyInvalidDev",()=>al,"getAuthAuthHeaderMissing",()=>ah,"missingDomainAndProxy",()=>af,"missingSignInUrlInDev",()=>ag],32987),a.i(9057);var am=a.i(12175);function an(a,b){if(!(0,am.detectClerkMiddleware)(a))throw Error(b)}function ao(a,b,c){if(!c||ad(a,b).toString()!==c)throw Error(aj)}let ap="clerk_keyless_dummy_key";function aq(a){if(!a)return{};let b=(0,d.isProductionEnvironment)()?ae.ENCRYPTION_KEY||ae.SECRET_KEY:ae.ENCRYPTION_KEY||ae.SECRET_KEY||ap;try{return as(a,b)}catch{if(l.canUseKeyless)try{return as(a,ap)}catch{ar()}ar()}}function ar(){if((0,d.isProductionEnvironment)())throw Error(ak);throw Error(al)}function as(a,b){return JSON.parse(aa.decrypt(a,b).toString(s))}a.s(["assertAuthStatus",()=>an,"assertTokenSignature",()=>ao,"decryptClerkRequestData",()=>aq],17898)},57729,a=>{"use strict";var b=a.i(85224);let c=a=>{if(!(a instanceof Error)||!("message"in a))return!1;let{message:b}=a,c=b.toLowerCase(),d=c.includes("dynamic server usage"),e=c.includes("this page needs to bail out of prerendering");return/Route .*? needs to bail out of prerendering at this point because it used .*?./.test(b)||d||e};async function d(){try{let{headers:c}=await a.A(96338),d=await c();return new b.NextRequest("https://placeholder.com",{headers:d})}catch(a){if(a&&c(a))throw a;throw Error(`Clerk: auth(), currentUser() and clerkClient(), are only supported in App Router (/app directory).
If you're using /pages, try getAuth() instead.
Original error: ${a}`)}}function e(a){var b;let c=a.split(";").map(a=>a.trim()),d=c.find(a=>a.startsWith("script-src"))||c.find(a=>a.startsWith("default-src"));if(!d)return;let e=null==(b=d.split(" ").slice(1).map(a=>a.trim()).find(a=>a.startsWith("'nonce-")&&a.length>8&&a.endsWith("'")))?void 0:b.slice(7,-1);if(e){if(/[&><\u2028\u2029]/g.test(e))throw Error("Nonce value from Content-Security-Policy contained invalid HTML escape characters, which is disallowed for security reasons. Make sure that your nonce value does not contain the following characters: `<`, `>`, `&`");return e}}a.s(["buildRequestLike",()=>d,"getScriptNonceFromHeader",()=>e,"isPrerenderingBailout",()=>c])}];

//# sourceMappingURL=node_modules__pnpm_ec8930a5._.js.map