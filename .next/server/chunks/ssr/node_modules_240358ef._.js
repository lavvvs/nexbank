...
For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)`;a.s(["authAuthHeaderMissing",()=>ai,"authSignatureInvalid",()=>aj,"encryptionKeyInvalid",()=>ak,"encryptionKeyInvalidDev",()=>al,"getAuthAuthHeaderMissing",()=>ah,"missingDomainAndProxy",()=>af,"missingSignInUrlInDev",()=>ag],75077),a.i(83693);var am=a.i(63365);function an(a,b){if(!(0,am.detectClerkMiddleware)(a))throw Error(b)}function ao(a,b,c){if(!c||ad(a,b).toString()!==c)throw Error(aj)}let ap="clerk_keyless_dummy_key";function aq(a){if(!a)return{};let b=(0,d.isProductionEnvironment)()?ae.ENCRYPTION_KEY||ae.SECRET_KEY:ae.ENCRYPTION_KEY||ae.SECRET_KEY||ap;try{return as(a,b)}catch{if(l.canUseKeyless)try{return as(a,ap)}catch{ar()}ar()}}function ar(){if((0,d.isProductionEnvironment)())throw Error(ak);throw Error(al)}function as(a,b){return JSON.parse(aa.decrypt(a,b).toString(s))}a.s(["assertAuthStatus",()=>an,"assertTokenSignature",()=>ao,"decryptClerkRequestData",()=>aq],54772)},24202,a=>{"use strict";var b=a.i(43405);let c=a=>{if(!(a instanceof Error)||!("message"in a))return!1;let{message:b}=a,c=b.toLowerCase(),d=c.includes("dynamic server usage"),e=c.includes("this page needs to bail out of prerendering");return/Route .*? needs to bail out of prerendering at this point because it used .*?./.test(b)||d||e};async function d(){try{let{headers:c}=await a.A(23804),d=await c();return new b.NextRequest("https://placeholder.com",{headers:d})}catch(a){if(a&&c(a))throw a;throw Error(`Clerk: auth(), currentUser() and clerkClient(), are only supported in App Router (/app directory).
...
//# sourceMappingURL=node_modules_240358ef._.js.map