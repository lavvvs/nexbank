...
"[project]/app/api/loans/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { loanType, amount, interestRate, tenureMonths, emiAmount, totalPayable, remainingAmount, disbursementAccountId } = body;
        // Validate required fields
        if (!loanType || !amount || !interestRate || !tenureMonths || !emiAmount || !totalPayable) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Create new loan
        const loan = new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Loan"]({
            userId,
            loanType,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12b3f5a7._.js.map