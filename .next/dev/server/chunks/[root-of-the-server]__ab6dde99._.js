...
"[project]/app/api/bank-settings/update/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(req) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$app$2d$router$2f$server$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"])();
    ...
    const { values } = body;
    if (!values || typeof values !== "object") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    try {
        ...
        const updates = Object.entries(values).map(([key, value])=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BankSetting"].findOneAndUpdate({
                setting_key: key
            }, {
                setting_value: value,
                updated_by: userId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab6dde99._.js.map