...
async function AdminDashboardPage() {
    ...
    // Fetch pending loans - now includes userName and userEmail from seed data
    ...
    // Serialize pending loans - use userName/userEmail directly from loan documents
    ...
    // Serialize recent transactions - use userName if available, otherwise show userId
    const recentTransactions = recentTransactionsDocs.map((txn)=>({
            id: txn._id.toString(),
            userId: txn.userId,
            userName: txn.userName || txn.userId || "Unknown",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14b31ecf._.js.map